...
int main() {
	...
	if (l[0] > l[1] + l[2] || l[1] > l[0] + l[2] || l[2] > l[1] + l[0]) {
		...
		if (l[0] == l[1] && l[1] == l[2]) {
			printf("\nO triangulo e equilatero"); //Mostrar ao usuário a informação
		} else if (l[0] == l[1] && l[1] != l[2] || l[2] == l[1] && l[1] != l[0] || l[0] == l[2] && l[2] != l[1]) {
			printf("\nO triangulo e isosceles"); //Mostrar ao usuário a informação
		} else {
			printf("\nO triangulo e escaleno"); //Mostrar ao usuário a informação
		}
	}
